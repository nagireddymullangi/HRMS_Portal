...
public interface DailyWorkService {
    AssignmentResponse createAssignment(DailyWorkAssignment assignment, Long assignedBy);
    ...
    // Comments
    AssignmentComment addComment(Long assignmentId, Long userId, String comment, String type);
    List<AssignmentComment> getComments(Long assignmentId);

    // Breaks
    BreakSessionResponse startBreak(Long employeeId, String breakType, String reason, String location);
    BreakSessionResponse endBreak(Long sessionId);
    List<BreakSessionResponse> getActiveBreaks();
